...
It is built on four universal invariants:
...
/domains
    Applied REID frameworks across human and system contexts

/diagrams
    Canonical REID architecture diagrams

/examples
    Demonstrations of REID in action

/vision
    Long‑arc integration and Microsoft ecosystem alignment
```

---

# ⭐ Core Architecture (in /core)
...
- **flows_overview.md**  
- **state_overview.md**  
- **mode_t_principles.md**  
- **invariant_interaction_map.md**  
- **compute_model.md**  

---

# ⭐ Domain Application Suite (in /domains)
...
These diagrams provide a structural overview of the architecture and its layers.
